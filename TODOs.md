...
- `cargo run --package longtable_runtime --bin longtable examples/adventure/_.lt` - should work with just the directory path too, e.g. `cargo run --package longtable_runtime --bin longtable examples/adventure` .
