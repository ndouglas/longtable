...
//! - [`debug`] - Breakpoints, watches, and stepping
...
pub use debug::{
    AccessType, Breakpoint, BreakpointId, BreakpointRegistry, DebugSession, DebugState,
    PauseReason, WatchExpression, WatchId, WatchRegistry,
};
pub use explain::{
...
pub use timeline::{
    Branch, BranchId, BranchRegistry, DiffGranularity, EntityDiff, HistoryBuffer, MergeResult,
    MergeStrategy, TickSnapshot, TickSummary, Timeline, TimelineConfig, ValueChange, WorldDiff,
    diff_summary, diff_worlds, format_diff, merge,
};
pub use trace::{
